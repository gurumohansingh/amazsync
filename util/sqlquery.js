module.exports = {
  ...
  getRestockSku: `select market_place,amz_sku,amz_current_price,amazonASIN,market_place,amazonFNSKU from restock left JOIN products on restock.amz_sku=products.sellerSKU where products.status='Active'`,
