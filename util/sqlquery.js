module.exports = {
    ...
    addProductFromSync: "INSERT INTO products (sellerId,user,itemName,sellerSKU,status,itemNote,dateAdded,amazonASIN,productId,productIdType,amzlive,imageUrl,imageHeight,imageWidth,masterSku,ismasterSku,itemNameLocal,isActive,isActiveLocal,isPartSKUOnly,UPC,UPCLocal,EAN,EANLocal,casePackQuantity,casePackUPC,packageWeight,packageDimensions,packageWeightLocal,dimensions,dimensionsLocal,amazonOversized,hazmat,itemNoteLocal,amazonFNSKU,lastUpdateFromAmazon,amazonPrepInstructions,additionalPrepInstructions,suppliers,expirationDateRequired,reshippingCost,prepMaterialCost,prepLaborCost,tag,amazonSnL,kit,changeLog,history,targetDaysInWarehouse,targetDaysInAmazon,countryofOriginLocal,htcCodeLocal) VALUES?",
