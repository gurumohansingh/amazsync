module.exports = {
  ...
  getRestockSku: `select market_place,amz_sku,amz_current_price,amazonASIN,market_place,amazonFNSKU,amz_avg_profit7,amz_avg_profit30,amz_avg_profit90 from restock left JOIN products on restock.amz_sku=products.sellerSKU where products.status='Active'`,
  ...
  getAllTableLayouts:
    "SELECT id,name,columnNames FROM tableLayouts WHERE tabName =? AND userId =?",
  getLayoutByName:
